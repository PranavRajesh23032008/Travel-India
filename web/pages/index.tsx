...
const Home: NextPage = () => {
  ...
  >
	...
	{error && (
				<p className={`flex items-center absolute bg-red-400 text-white animate-bounce px-3 py-2 rounded-md text-md shadow-md top-5 right-5`}>
					<svg onClick={() => setError("")} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-1 cursor-pointer">
	...
	<div className={"bg-white p-10 shadow-md rounded-md border border-gray-200 "}>
		<Image
			src={LoginImage}
			alt={"LoginImage"}
			height={200}
